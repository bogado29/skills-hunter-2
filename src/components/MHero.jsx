						...
						<div class="css-4p9r15">
							<div class="css-1y0s2bx">
								<div class="css-1mstnnf">
									<div class="css-4p9r15">
										<h2 class="css-1xvysa8">Aprende React en <span>30 dias</span> con
											 excelentes 	instructores!</h2>
									...
									<div class="css-tpo2py"><a aria-current="page" class="css-874zgm"
										href="https://flexiblog-education.netlify.app/">Empezar a 
										aprender</a><a class="css-7hq3ru"
											href="https://flexiblog-education.netlify.app/authors">Ver los
											Tutores</a></div>
								</div>
